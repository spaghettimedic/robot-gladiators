...
var fight = function(enemy) {
    ...
    while(playerInfo.health > 0 && enemy.health > 0) {
        ...
        if (promptFight === "skip" || promptFight === "SKIP") {
            ...
            var confirmSkip = window.confirm("Are you sure you'd like to skip this fight? 10 money will be deducted from your balance.");
...
var startGame = function () {
    ...
    for(var i = 0; i < enemyInfo.length; i++) {
        if (playerInfo.health > 0){
            ...
            // use debugger to pause sccript from running and check what's going on at that moment in the code
            // debugger;
